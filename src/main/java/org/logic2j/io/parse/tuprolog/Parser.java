...
import static org.logic2j.io.parse.tuprolog.MaskConstants.ATOM;
import static org.logic2j.io.parse.tuprolog.MaskConstants.DQ_SEQUENCE;
import static org.logic2j.io.parse.tuprolog.MaskConstants.END;
...
import static org.logic2j.io.parse.tuprolog.MaskConstants.LBRA;
import static org.logic2j.io.parse.tuprolog.MaskConstants.LBRA2;
import static org.logic2j.io.parse.tuprolog.MaskConstants.LPAR;
import static org.logic2j.io.parse.tuprolog.MaskConstants.RBRA;
import static org.logic2j.io.parse.tuprolog.MaskConstants.RBRA2;
import static org.logic2j.io.parse.tuprolog.MaskConstants.RPAR;
import static org.logic2j.io.parse.tuprolog.MaskConstants.SQ_SEQUENCE;
import static org.logic2j.io.parse.tuprolog.MaskConstants.VARIABLE;
...
public class Parser implements Serializable {
  ...
  /**
   * creating a TermFactory specifing how to handle operators
  ...
  public Term parseSingleTerm() throws InvalidTermException {
    try {
      ...
      if (!this.tokenizer.readToken().isEOF()) {
        throw new InvalidTermException("The entire term could not be parsed, parsing failed before the end, stopped after \""
            + term + '"');
      }
      return term;
    } catch (IOException ex) {
  ...
  private LinkedList<Term> exprA0_arglist() throws InvalidTermException, IOException {
    ...
    throw new InvalidTermException("The argument: \"" + head + "\" is not followed by either a ',' or ')'; at line: "
