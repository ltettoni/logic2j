...
public class FunctionLibrary extends LibraryBase {
  ...
  @Primitive
  public Continuation mapBottomUp(SolutionListener theListener, final Bindings theBindings, final Object thePredicate,
      final Object theInput, final Object theOutput) {
    ...
    if (theInputBindings == null) {
      ...
      final boolean unified = unify(termAndBindings[0], (Bindings) termAndBindings[1], theOutputBindings.getReferrer(),
          theOutputBindings);
   ...
   * @return
   */
  public boolean transformOnce(final String theTransformationPredicate, final Object[] termAndBindings, int childrenBefore,
      int childrenAfter) {
  ...
  public boolean transformOnce(final String theTransformationPredicate, final Object[] termAndBindings) {
    ...
    final Struct transformationGoal = (Struct) TermApi.normalize(
        new Struct(theTransformationPredicate, transIn, transOut), /* no library to consider */null);
