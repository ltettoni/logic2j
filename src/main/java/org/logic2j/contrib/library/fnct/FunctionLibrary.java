...
public class FunctionLibrary extends LibraryBase {
   ...
   */
  @Predicate
  public Integer map(SolutionListener listener, final UnifyContext currentVars, final Object mappingPredicate, final Object inputTerm,
      final Object outputTerm) {
  ...
  @Predicate
  public Integer map(SolutionListener listener, final UnifyContext currentVars, final Object mappingPredicate, final Object inputTerm,
      final Object outputTerm, final Object theOptions) {
   ...
   * @return
   */
  protected UnifyContext mapCompletely(String mappingPredicate, UnifyContext currentVars, Object inputTerm, Object outputTerm,
  ...
  private UnifyContext mapOneLevel(String mappingPredicate, UnifyContext currentVars, Object inputTerm, Object outputTerm,
      final TransformationInfo returnInfo) {
    returnInfo.recursionCounter++;
    UnifyContext runningMonad = currentVars;
    ...
    if (returnInfo.isIterative) {
      ...
      runningMonad = mapOne(mappingPredicate, runningMonad, inputTerm, outputTerm, returnInfo);
    }
    return runningMonad;
  }
   ...
   * @return
   */
  public UnifyContext mapOne(final String mappingPredicate, final UnifyContext currentVars, final Object inputTerm, final Object outputTerm,
      final TransformationInfo returnInfo) {
    returnInfo.recursionCounter++;
  ...
  public Integer mapOneProto(final SolutionListener listener, final UnifyContext currentVars, final Object mappingPredicate, final Object inputTerm,
      final Object outputTerm) {
    UnifyContext runningMonad = currentVars;
    final Object effectiveInput = runningMonad.reify(inputTerm);
    final Object effectiveOutput = runningMonad.reify(outputTerm);
