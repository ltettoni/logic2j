    ...
    public static class Join {
        ...
        public String generate(Table theReferenceTable) {
            if (!theReferenceTable.equals(this.rightColumn.getTable())) {
                return this.joinType + " join " + this.rightColumn.getTable().declaration() + " on " + this.rightColumn + OPERATOR_EQ_OR_IN + this.leftColumn;
            }
            if (!theReferenceTable.equals(this.leftColumn.getTable())) {
                return this.joinType + " join " + this.leftColumn.getTable().declaration() + " on " + this.leftColumn + OPERATOR_EQ_OR_IN + this.rightColumn;
            }
