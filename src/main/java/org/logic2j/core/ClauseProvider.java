 ...
 * the {@link org.logic2j.core.Solver.solve.GoalSolver} inference engine.
 ...
 * return iterable results sets, for example from database cursors. The {@link org.logic2j.core.Solver.solve.GoalSolver} does
 * not need all clauses in memory at once!
 * 
 * Contract: The {@link org.logic2j.core.Solver.solve.GoalSolver} will never cache the result from
...
public interface ClauseProvider {
   ...
   * the {@link org.logic2j.core.Solver.solve.GoalSolver} will determine by unification
   ...
   * the {@link org.logic2j.core.Solver.solve.GoalSolver}.
   */
