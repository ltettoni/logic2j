...
/**
 * Provide {@link Clause}s (facts or rules) from various content sources to the {@link org.logic2j.core.solver.Solver} inference
 ...
 * database cursors. The {@link org.logic2j.core.solver.Solver} does not need all clauses in memory at once!
 * 
 * Contract: The {@link org.logic2j.core.solver.Solver} will never cache the result from {@link #listMatchingClauses(Struct, Bindings)},
...
public interface ClauseProvider {
     ...
     * broader than actually needed, the {@link org.logic2j.core.solver.Solver} will determine by unification if {@link Clause}s
     ...
     *         {@link org.logic2j.core.solver.Solver}.
     */
