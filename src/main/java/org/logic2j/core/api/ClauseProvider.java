...
/**
 * Provide {@link Clause}s (facts or rules) from various content sources to the {@link org.org.logic2j.core.api.Solver} inference
 ...
 * database cursors. The {@link org.org.logic2j.core.api.Solver} does not need all clauses in memory at once!
 * 
 * Contract: The {@link org.org.logic2j.core.api.Solver} will never cache the result from {@link #listMatchingClauses(Struct, Bindings)},
...
public interface ClauseProvider {
     ...
     * broader than actually needed, the {@link org.org.logic2j.core.api.Solver} will determine by unification if {@link Clause}s
