...
public abstract class SingleSolutionListener implements SolutionListener {
   ...
   * @param theBindings 
   * @param theMaxCount The maximal number of solutions to ask the inference engine;
   * specify 1 to only look for the first, irrelevant whether there might be others; 
   * specify 2 to if you want the first and make sure there are no others
   * (the inference engine will try to continue after the first).
   */
