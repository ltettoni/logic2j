...
public class StructTest {
    ...
    public void listsFundamentals() throws Exception {
        ...
        assertThat(pList.listHead()).isEqualTo(5);
        assertThat(pList.listHead()).isEqualTo(pList.getLHS());
        assertThat(pList.getRHS().toString()).isEqualTo("[6,7]");
        assertThat(pList.listTail().toString()).isEqualTo("[6,7]");
        assertThat(pList.listTail()).isEqualTo(pList.getRHS());
    }
    ...
    public void listsSize0() throws Exception {
        final Struct pList = Struct.createPList(new Object[0]);
        assertThat(pList).isNotNull();
        assertThat(pList.listSize()).isEqualTo(0);
    }
    ...
    public void listsSize1() throws Exception {
        final Struct pList = Struct.createPList(new Object[]{5});
        assertThat(pList).isNotNull();
        assertThat(pList.listSize()).isEqualTo(1);
    }
    ...
    public void listsSize3() throws Exception {
        final Struct pList = Struct.createPList(new Object[]{5, 6, 7});
        assertThat(pList).isNotNull();
        assertThat(pList.listSize()).isEqualTo(3);
    }
